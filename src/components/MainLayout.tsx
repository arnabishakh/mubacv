...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  return (
    <div className={`min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200`}>
      ...
      <aside className="fixed top-0 left-0 h-full w-64 bg-gray-100 dark:bg-gray-800 shadow-lg z-30 transition-all duration-300">
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 text-center border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="relative mx-auto w-32 h-32 mb-4 overflow-hidden rounded-full border-2 border-gray-200 dark:border-gray-700 shadow-md">
              <img 
                src="/lovable-uploads/8b0fa67c-a760-4d0f-b1ff-f326f8eafbb0.png" 
                alt="Mubashir Mohsin" 
          ...
          <div className="flex-1 overflow-y-auto px-4 py-6">
            ...
            <div className="mt-8 px-2">
              <a
                href="https://lab.mubashirmohsin.com" 
                target="_blank"
                rel="noopener noreferrer"
